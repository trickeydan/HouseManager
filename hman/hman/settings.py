"""
Django settings for hman project.
...
SECRET_KEY = '4t17fl&v4rtwd$2**=km#khu&+-+^bg6@%gfx7f*s3qg&jlff%'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'hman.context_processors.me'
            ],
        },
    },
]

WSGI_APPLICATION = 'hman.wsgi.application'
